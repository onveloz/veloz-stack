...
export const GIT_HOOK_CHOICES = ["none", "husky", "lefthook"] as const satisfies readonly GitHookChoice[];
export const LINTER_CHOICES = ["none", "biome", "oxlint"] as const satisfies readonly LinterChoice[];

    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <p className="text-muted-foreground max-w-2xl mb-10 leading-relaxed">
          ...
          . Cada projeto inclui{" "}
          <code className="font-mono text-sm">veloz-stack.jsonc</code> na raiz —
          o manifesto do stack escolhido (como o{" "}
          <code className="font-mono text-sm">bts.jsonc</code> no
          Better-T-Stack).
        </p>
        ...
        <section className="mt-14 border border-border border-dashed p-6 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4 max-w-lg mx-auto">
            ...
            stack. Mantenha{" "}
            <code className="font-mono text-xs">veloz-stack.jsonc</code>{" "}
            commitado — ajuda a comunidade a achar projetos no GitHub.
          </p>
          <a

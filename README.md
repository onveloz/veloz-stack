...
- **[Biome](https://biomejs.dev/)** — `pnpm lint`, `pnpm lint:fix`; CI runs `pnpm lint` in the unit job.
- **[Lefthook](https://github.com/evilmartians/lefthook)** — hooks after `pnpm install` (`lefthook install` via `prepare`).
